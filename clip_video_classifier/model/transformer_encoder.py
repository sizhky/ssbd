# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/model/02_transformer.ipynb.

# %% auto 0
__all__ = ["PositionalEncoding", "TransformerEncoder"]

# %% ../../nbs/model/02_transformer.ipynb 3
from ..cli import cli
...
# %% ../../nbs/model/02_transformer.ipynb 4
...
class TransformerEncoder(nn.Module):
    ...
    def forward(self, embeddings, attention_mask, targets):
